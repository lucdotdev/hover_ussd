 ...
 * HoverUssdPlugin
 */
public class HoverUssdPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware, PluginRegistry.ActivityResultListener, EventChannel.StreamHandler, Hover.DownloadListener {
    ...
    ///when hover action dowload failed

    @Override
    public void onError(String s) {
        Log.e("HOVER_ERROR:", s);
        eventSink.success("actionDownloadFailed");
    }
    ///when hover action dowload succeded

    @Override
    public void onSuccess(ArrayList<HoverAction> arrayList) {
        Log.d("HOVER_MSG:", "Action succesful downloaded");
    }
}
